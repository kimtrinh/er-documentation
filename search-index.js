...
const SEARCH_INDEX = [
  ...
  // ── DOTPHRASES ─────────────────────────────────────────────────────────
  {type:'phrase',i:'📋',t:'PE Rule-Out',s:'.nope  ·  Chest Pain  ·  chest pain dyspnea SOB shortness of breath',g:'Chest Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Aortic Dissection Rule-Out',s:'.nodissection  ·  Chest Pain  ·  chest pain dyspnea SOB shortness of breath',g:'Chest Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'ACS Rule-Out',s:'.noacs  ·  Chest Pain  ·  chest pain dyspnea SOB shortness of breath',g:'Chest Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Pneumothorax Rule-Out',s:'.nopneumo  ·  Chest Pain  ·  chest pain dyspnea SOB shortness of breath',g:'Chest Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Cardiac Tamponade Rule-Out',s:'.notamponade  ·  Chest Pain  ·  chest pain dyspnea SOB shortness of breath',g:'Chest Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'SAH Rule-Out',s:'.nosah  ·  Headache  ·  headache head pain thunderclap migraine',g:'Headache',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Meningitis/Encephalitis Rule-Out',s:'.nomeningitis  ·  Headache  ·  headache head pain thunderclap migraine',g:'Headache',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Stroke Rule-Out',s:'.nostroke  ·  Headache  ·  headache head pain thunderclap migraine',g:'Headache',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hypertensive Emergency Rule-Out',s:'.nohypertensiveemergency  ·  Headache  ·  headache head pain thunderclap migraine',g:'Headache',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Cerebral Venous Thrombosis Rule-Out',s:'.nocvt  ·  Headache  ·  headache head pain thunderclap migraine',g:'Headache',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'AAA / Aortic Emergency Rule-Out',s:'.noaaa  ·  Abdominal Pain  ·  abdominal pain belly stomach nausea vomiting',g:'Abdominal Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Ectopic Pregnancy Rule-Out',s:'.noectopic  ·  Abdominal Pain  ·  abdominal pain belly stomach nausea vomiting',g:'Abdominal Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Appendicitis Rule-Out',s:'.noappendix  ·  Abdominal Pain  ·  abdominal pain belly stomach nausea vomiting',g:'Abdominal Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Mesenteric Ischemia Rule-Out',s:'.nomesischemia  ·  Abdominal Pain  ·  abdominal pain belly stomach nausea vomiting',g:'Abdominal Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Small Bowel Obstruction Rule-Out',s:'.nosbo  ·  Abdominal Pain  ·  abdominal pain belly stomach nausea vomiting',g:'Abdominal Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Ovarian Torsion Rule-Out',s:'.noovariantorsion  ·  Abdominal Pain  ·  abdominal pain belly stomach nausea vomiting',g:'Abdominal Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Epigastric Pain Rule-Out (Pancreatitis / Hepatitis / Biliary)',s:'.noepigastric  ·  Abdominal Pain  ·  abdominal pain belly stomach nausea vomiting',g:'Abdominal Pain',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Upper GI Bleed Documentation',s:'.nougibleed  ·  GI  ·  GI gastrointestinal bleeding GIB UGIB LGIB',g:'GI',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Lower GI Bleed Documentation',s:'.nolgibleed  ·  GI  ·  GI gastrointestinal bleeding GIB UGIB LGIB',g:'GI',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Liver Failure / Hepatic Encephalopathy',s:'.nohepfailure  ·  GI  ·  GI gastrointestinal bleeding GIB UGIB LGIB',g:'GI',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Bowel Perforation Rule-Out',s:'.nobowelperf  ·  GI  ·  GI gastrointestinal bleeding GIB UGIB LGIB',g:'GI',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Intracranial Injury Rule-Out (Head Trauma)',s:'.nonci  ·  Neuro  ·  neuro neurological weakness numbness paralysis',g:'Neuro',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Seizure Work-Up Documented',s:'.noseizure  ·  Neuro  ·  neuro neurological weakness numbness paralysis',g:'Neuro',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Guillain-Barré Rule-Out',s:'.nogbs  ·  Neuro  ·  neuro neurological weakness numbness paralysis',g:'Neuro',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Cauda Equina Syndrome Rule-Out',s:'.nocaudaequina  ·  Neuro  ·  neuro neurological weakness numbness paralysis',g:'Neuro',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Preeclampsia/Eclampsia Rule-Out',s:'.noeclampsia  ·  OB  ·  OB obstetrics pregnancy gravid prenatal',g:'OB',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'HELLP Syndrome Rule-Out',s:'.nohellp  ·  OB  ·  OB obstetrics pregnancy gravid prenatal',g:'OB',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Placental Abruption Rule-Out',s:'.noabruption  ·  OB  ·  OB obstetrics pregnancy gravid prenatal',g:'OB',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Intussusception Rule-Out',s:'.nointussusception  ·  Peds  ·  pediatric peds child infant',g:'Peds',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Malrotation/Volvulus Rule-Out',s:'.novolvulus  ·  Peds  ·  pediatric peds child infant',g:'Peds',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Epiglottitis Rule-Out',s:'.noepiglottitis  ·  Peds  ·  pediatric peds child infant',g:'Peds',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Non-Accidental Trauma Screen',s:'.nonat  ·  Peds  ·  pediatric peds child infant',g:'Peds',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Mastoiditis Rule-Out',s:'.nomastoiditis  ·  Head & Neck  ·  head neck ENT ear nose throat abscess',g:'Head & Neck',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Peritonsillar Abscess Rule-Out',s:'.nopta  ·  Head & Neck  ·  head neck ENT ear nose throat abscess',g:'Head & Neck',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Retropharyngeal Abscess Rule-Out',s:'.norpha  ·  Head & Neck  ·  head neck ENT ear nose throat abscess',g:'Head & Neck',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Malignant Otitis Externa Rule-Out',s:'.nomalignantotitis  ·  Head & Neck  ·  head neck ENT ear nose throat abscess',g:'Head & Neck',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Temporal Arteritis (GCA) Rule-Out',s:'.nogca  ·  Head & Neck  ·  head neck ENT ear nose throat abscess',g:'Head & Neck',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Lemierre\'s Syndrome Rule-Out',s:'.nolemierres  ·  Head & Neck  ·  head neck ENT ear nose throat abscess',g:'Head & Neck',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Thyroid Storm Rule-Out',s:'.nothyroidstorm  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Myxedema Coma Rule-Out',s:'.nomyxedema  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Adrenal Crisis Rule-Out',s:'.noadrenalcrisis  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Acute Angle-Closure Glaucoma Rule-Out',s:'.noglaucoma  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Ludwig\'s Angina / Deep Space Neck Infection Rule-Out',s:'.noludsangina  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Fournier\'s Gangrene Rule-Out',s:'.nofourgangr  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Central Retinal Artery Occlusion',s:'.nocrao  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Wernicke\'s Encephalopathy Rule-Out',s:'.noWernicke  ·  High-Risk Dx  ·  high risk life threatening emergent critical',g:'High-Risk Dx',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Against Medical Advice (AMA)',s:'.ama  ·  Disposition  ·  disposition discharge AMA refusal capacity',g:'Disposition',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Shared Decision-Making: Low-Risk Chest Pain Discharge',s:'.sdmlowriskcp  ·  Disposition  ·  disposition discharge AMA refusal capacity',g:'Disposition',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Shared Decision-Making: LP for SAH Rule-Out',s:'.sdmlpsdm  ·  Disposition  ·  disposition discharge AMA refusal capacity',g:'Disposition',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Decision-Making Capacity Confirmed',s:'.capacityok  ·  Disposition  ·  disposition discharge AMA refusal capacity',g:'Disposition',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Return Precautions Documented',s:'.noreturn  ·  Disposition  ·  disposition discharge AMA refusal capacity',g:'Disposition',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Syncope — Low Risk, Discharge',s:'.nosyncope  ·  High-Volume  ·  high volume syncope etoh alcohol altered AMS',g:'High-Volume',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Alcohol Intoxication / Medical Clearance',s:'.etohclearance  ·  High-Volume  ·  high volume syncope etoh alcohol altered AMS',g:'High-Volume',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Altered Mental Status Work-Up',s:'.alteredms  ·  High-Volume  ·  high volume syncope etoh alcohol altered AMS',g:'High-Volume',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Renal Colic / Nephrolithiasis',s:'.flankpain  ·  High-Volume  ·  high volume syncope etoh alcohol altered AMS',g:'High-Volume',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Anaphylaxis Documentation',s:'.noanaphylaxis  ·  Airway / Respiratory  ·  airway respiratory breathing wheezing COPD asthma',g:'Airway / Respiratory',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Angioedema / Airway Threat Assessment',s:'.noangioedema  ·  Airway / Respiratory  ·  airway respiratory breathing wheezing COPD asthma',g:'Airway / Respiratory',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Asthma Exacerbation Severity',s:'.noasthma  ·  Airway / Respiratory  ·  airway respiratory breathing wheezing COPD asthma',g:'Airway / Respiratory',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Acute Pulmonary Edema / CHF Exacerbation',s:'.nochf  ·  Airway / Respiratory  ·  airway respiratory breathing wheezing COPD asthma',g:'Airway / Respiratory',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Aspiration Pneumonia Risk Documentation',s:'.noaspiration  ·  Airway / Respiratory  ·  airway respiratory breathing wheezing COPD asthma',g:'Airway / Respiratory',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Atrial Fibrillation with RVR — Rate Control',s:'.noafib  ·  Cardiology  ·  cardiology cardiac heart arrhythmia rhythm',g:'Cardiology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Bradycardia / Heart Block Documentation',s:'.nobradycardia  ·  Cardiology  ·  cardiology cardiac heart arrhythmia rhythm',g:'Cardiology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hypertensive Urgency Discharge',s:'.nohypertensiveurgency  ·  Cardiology  ·  cardiology cardiac heart arrhythmia rhythm',g:'Cardiology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'AKI Workup',s:'.noaki  ·  Renal / Metabolic  ·  renal metabolic kidney electrolyte AKI CKD',g:'Renal / Metabolic',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hyperkalemia Management',s:'.nohyperkalemia  ·  Renal / Metabolic  ·  renal metabolic kidney electrolyte AKI CKD',g:'Renal / Metabolic',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'DKA / HHS Documentation',s:'.nodka  ·  Renal / Metabolic  ·  renal metabolic kidney electrolyte AKI CKD',g:'Renal / Metabolic',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hyponatremia Workup',s:'.nohyponatremia  ·  Renal / Metabolic  ·  renal metabolic kidney electrolyte AKI CKD',g:'Renal / Metabolic',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hypoglycemia Workup',s:'.nohypoglycemia  ·  Renal / Metabolic  ·  renal metabolic kidney electrolyte AKI CKD',g:'Renal / Metabolic',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hypercalcemia Workup',s:'.nohypercalcemia  ·  Renal / Metabolic  ·  renal metabolic kidney electrolyte AKI CKD',g:'Renal / Metabolic',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Epididymo-Orchitis Rule-Out',s:'.noepididymitis  ·  GU / GYN  ·  GU GYN urologic gynecologic',g:'GU / GYN',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Pelvic Inflammatory Disease Documentation',s:'.nopid  ·  GU / GYN  ·  GU GYN urologic gynecologic',g:'GU / GYN',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Urinary Retention Documentation',s:'.nourinaryretention  ·  GU / GYN  ·  GU GYN urologic gynecologic',g:'GU / GYN',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Suicidal Ideation Risk Stratification',s:'.siscreen  ·  Psychiatric  ·  psych psychiatric mental health SI HI suicide',g:'Psychiatric',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Homicidal Ideation Screening',s:'.hiscreen  ·  Psychiatric  ·  psych psychiatric mental health SI HI suicide',g:'Psychiatric',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Agitation / Excited Delirium Documentation',s:'.agitation  ·  Psychiatric  ·  psych psychiatric mental health SI HI suicide',g:'Psychiatric',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Psychiatric Medical Clearance',s:'.psychmedclear  ·  Psychiatric  ·  psych psychiatric mental health SI HI suicide',g:'Psychiatric',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Acetaminophen Overdose Risk Stratification',s:'.noacetaminophen  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Salicylate Toxicity Rule-Out',s:'.nosalicylate  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'TCA Overdose Rule-Out',s:'.notca  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Serotonin Syndrome Rule-Out',s:'.noserotonin  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Anticholinergic Toxidrome Rule-Out',s:'.noanticholinergic  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Opioid Toxicity / Overdose',s:'.noopioidtox  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Heat Stroke Rule-Out',s:'.noheatstroke  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hypothermia Management',s:'.nohypothermia  ·  Toxicology  ·  tox toxicology overdose poisoning OD',g:'Toxicology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Neutropenic Fever',s:'.noneutropenic  ·  Hematology / Oncology  ·  heme hematology oncology cancer blood',g:'Hematology / Oncology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Sickle Cell Crisis Documentation',s:'.nosicklecell  ·  Hematology / Oncology  ·  heme hematology oncology cancer blood',g:'Hematology / Oncology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Hyperviscosity Syndrome Rule-Out',s:'.nohyperviscosity  ·  Hematology / Oncology  ·  heme hematology oncology cancer blood',g:'Hematology / Oncology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Tumor Lysis Syndrome Rule-Out',s:'.notumourlysis  ·  Hematology / Oncology  ·  heme hematology oncology cancer blood',g:'Hematology / Oncology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Septic Arthritis Rule-Out',s:'.nosepticjoint  ·  Infectious Disease  ·  infectious disease infection fever sepsis',g:'Infectious Disease',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Osteomyelitis Rule-Out',s:'.noosteo  ·  Infectious Disease  ·  infectious disease infection fever sepsis',g:'Infectious Disease',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Endocarditis Risk Documentation',s:'.noendocarditis  ·  Infectious Disease  ·  infectious disease infection fever sepsis',g:'Infectious Disease',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Acute Limb Ischemia Rule-Out',s:'.nolimbischemia  ·  Vascular  ·  vascular ischemia blood vessel clot DVT PE',g:'Vascular',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'DVT Rule-Out',s:'.nodvt  ·  Vascular  ·  vascular ischemia blood vessel clot DVT PE',g:'Vascular',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Compartment Syndrome Rule-Out',s:'.nocompartment  ·  Vascular  ·  vascular ischemia blood vessel clot DVT PE',g:'Vascular',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Retinal Detachment Rule-Out',s:'.noretinaldetach  ·  Ophthalmology  ·  ophthalmology eye vision ocular',g:'Ophthalmology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Orbital vs Preseptal Cellulitis',s:'.noorbitalcellulitis  ·  Ophthalmology  ·  ophthalmology eye vision ocular',g:'Ophthalmology',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Scaphoid Fracture Rule-Out',s:'.noscaphoid  ·  MSK / Trauma  ·  MSK musculoskeletal trauma fracture dislocation',g:'MSK / Trauma',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Spinal Cord Injury / SCIWORA Rule-Out',s:'.nospinalcord  ·  MSK / Trauma  ·  MSK musculoskeletal trauma fracture dislocation',g:'MSK / Trauma',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Lisfranc Injury Rule-Out',s:'.nolisfranc  ·  MSK / Trauma  ·  MSK musculoskeletal trauma fracture dislocation',g:'MSK / Trauma',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Domestic Violence Screening',s:'.dvscreen  ·  Social / Legal  ·  social legal capacity EMTALA domestic violence DV',g:'Social / Legal',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Capacity to Refuse Imaging / Procedure',s:'.refusalimaging  ·  Social / Legal  ·  social legal capacity EMTALA domestic violence DV',g:'Social / Legal',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'EMTALA Medical Screening Exam',s:'.emtala  ·  Social / Legal  ·  social legal capacity EMTALA domestic violence DV',g:'Social / Legal',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'High-Risk Wound Exploration',s:'.woundexplore  ·  Wound / Derm  ·  wound derm skin abscess laceration cellulitis',g:'Wound / Derm',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Abscess I&D Documentation',s:'.abscessid  ·  Wound / Derm  ·  wound derm skin abscess laceration cellulitis',g:'Wound / Derm',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Soft Tissue Infection — Severity Assessment',s:'.nonecksofttissue  ·  Wound / Derm  ·  wound derm skin abscess laceration cellulitis',g:'Wound / Derm',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Thoracentesis Documentation',s:'.procthoracentesis  ·  Procedures  ·  procedure thoracentesis paracentesis pericardiocentesis',g:'Procedures',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Paracentesis Documentation',s:'.procparacentesis  ·  Procedures  ·  procedure thoracentesis paracentesis pericardiocentesis',g:'Procedures',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Cardioversion Documentation',s:'.proccardioversion  ·  Procedures  ·  procedure thoracentesis paracentesis pericardiocentesis',g:'Procedures',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Pericardiocentesis Documentation',s:'.procpericardiocentesis  ·  Procedures  ·  procedure thoracentesis paracentesis pericardiocentesis',g:'Procedures',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Sepsis Screening',s:'.nosepsis  ·  Other',g:'Other',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Testicular Torsion Rule-Out',s:'.notorsion  ·  Other',g:'Other',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Spinal Epidural Abscess Rule-Out',s:'.nosea  ·  Other',g:'Other',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Necrotizing Fasciitis Rule-Out',s:'.nonecfasc  ·  Other',g:'Other',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Carbon Monoxide Poisoning Rule-Out',s:'.noco  ·  Other',g:'Other',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Lumbar Puncture',s:'.consentlp  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Central Line (CVC)',s:'.consentcl  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Endotracheal Intubation / RSI',s:'.consentintubation  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Procedural Sedation',s:'.consentprocsedation  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Chest Tube / Tube Thoracostomy',s:'.consentchesttube  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Thoracentesis',s:'.consentthoracentesis  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Paracentesis',s:'.consentparacentesis  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Cardioversion (Elective)',s:'.consentcard  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Transcutaneous Pacing',s:'.consentpacing  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Pericardiocentesis',s:'.consentpericardio  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Laceration Repair',s:'.consentlaceration  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Incision & Drainage (I&D)',s:'.consentidabscess  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  {type:'phrase',i:'📋',t:'Consent — Fracture / Dislocation Reduction',s:'.consentfracturereduction  ·  Consent  ·  consent informed procedure',g:'Consent',gc:'t-phrase',u:'index.html'},
  ...
  // ── SITE PAGES ──────────────────────────────────────────────────────────
  {type:'page',i:'🤝',t:'Agreements & Protocols',s:'Kaiser  ·  SCPMG  ·  department agreements  ·  policies  ·  clinical protocols',g:'Reference',gc:'t-algo',u:'agreements.html'},
